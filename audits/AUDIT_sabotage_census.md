...
The hand-triggered weekly CI receipt is pending. The separate engine CI v1258 replay drift is already reproducible on the unchanged base; it remains outside this tooling change.
