...
```javascript
{
  ...
  worn[],                 // #388: STORED inventory strings currently worn/held-ready — never an item not in inventory (wornSet refuses; ITEM_LOST prunes; ITEM_RENAMED follows). Companion charSheets carry the same two fields
