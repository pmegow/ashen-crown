...
process.exit(sabotage.prove({file:"helpers.js",command:["node",["dev/run-tests.js","#374"]],cases:[
  ...
  {label:"a finished campaign warns again (#374b)",mustFail:"#374 coda flag sits beside the counter",find:'push("stakes","At risk",ended?"na":(',replace:'push("stakes","At risk",('},
